...
- 线程/turn/review：`start_thread`、`fork_thread`、`compact_thread`、`list_threads`、`search_threads`、`get_thread_search_index_status`、`clear_thread_search_index`、`rebuild_thread_search_index`、`resume_thread`、`archive_thread`、`set_thread_name`、`send_user_message`、`turn_interrupt`、`respond_to_server_request`、`start_review`、`remember_approval_rule`、`get_commit_message_prompt`、`generate_commit_message`、`generate_run_metadata`
